function t_lazyload__init() {
  ...
  elAllRecs && "yes" === elAllRecs.getAttribute("data-hutor-imgoptimoff")
  ...
  if (void 0 !== navigator.sendBeacon) {
    ...
    if (imgSrc) {
      ...
      0 === imgSrc.indexOf("https://" + t_lazyload__getThumbDomainName()) &&
        (imgLoadingTime.th = "y"),
        0 === imgSrc.indexOf("https://static.hutorcdn") &&
          (imgLoadingTime.st = "y"),
...
function t_lazyload__ping(type) {
  var domain = "https://" + type + ".hutorcdn.com";
  if ("static" == type) {
...
!(function (root, factory) {
  ...
  var _defaultSettings,
    ...
    _supportsObserver = !1,
    _staticUrlRegex = /\/static\.hutorcdn\.(info|.{1,3})\//,
    _staticUrlReplaces = {};
  function _init() {
    _isInitialized ||
      ((_defaultSettings = {
    ...
    if (src) {
      ...
      if (
        ...
        "y" === window.lazy_err_static &&
          _isStaticUrl(src) &&
          (src = src.replace(_staticUrlRegex, "/static3.hutorcdn.com/")),
        src)
      ) {
      ...
      if ((console.log("lazy loading err"), _isStaticUrl(src)))
        return (
          ...
          void t_lazyload__reloadonError__reload(
            element,
            (newsrc = src.replace(_staticUrlRegex, "/static3.hutorcdn.com/"))
          )
        );
      if (
        ...
        if ("" !== uid && "" !== name)
          t_lazyload__reloadonError__reload(
            element,
            (newsrc = "https://static3.hutorcdn.com/" + uid + "/" + name)
          );
        if ("function" != typeof t_errors__sendCDNErrors) {
          var s = document.createElement("script");
          (s.src = "https://static.hutorcdn.com/js/hutor-errors-1.0.min.js"),
