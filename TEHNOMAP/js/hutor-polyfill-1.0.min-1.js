  ...
  Object.keys ||
    (Object.keys = (function () {
      ...
      return function (o) {
        ...
        if (t) for (a = 0; a < n; a++) e.call(o, r[a]) && i.push(r[a]);
        return i;
      };
    })()),
            ...
            function (e, t) {
              for (var r = 0, n; (n = c[r]); ++r)
                if (n[0] == this && n[1] == e && n[2] == t)
                  return this.detachEvent("on" + e, c.splice(r, 1)[0][3]);
            }),
        (e.dispatchEvent =
          t.dispatchEvent =
          r.dispatchEvent =
  ...
  (function () {
    ...
    (r.prototype = {
      ...
      window.DOMTokenList &&
        ...
        (DOMTokenList.prototype.replace = r.prototype.replace);
  })(),
  Date.now ||
    (Date.now = function e() {
      ...
      Object.querySelectorAll =
        function e(t, r, n, o, i) {
          ...
          for (
            i = c.all,
              r = [],
              n = (t = t.replace(/\[for\b/gi, "[htmlFor").split(",")).length;
            n--;

          ) {
            for (a.addRule(t[n], "k:v"), o = i.length; o--; )
              i[o].currentStyle.k && r.push(i[o]);
            a.removeRule(0);
          }
          return r;
        }),
  ...
  (function () {
    if (document.documentMode <= 8) {
      ...
      Array.prototype.slice = function () {
        ...
        for (
          var t = [],
            r = arguments.length >= 1 ? arguments[0] : 0,
            n = arguments.length >= 2 ? arguments[1] : this.length,
            o = r;
          o < n;
          o++
        )
